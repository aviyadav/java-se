...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo(String title, String description) {
        Contact contact = new Contact("Indra Basak", "", "developer@gmail.com");
        return new ApiInfo(title, description, "1.0", "terms of controller url", contact.getName(), "license", "license url");
    }
}
