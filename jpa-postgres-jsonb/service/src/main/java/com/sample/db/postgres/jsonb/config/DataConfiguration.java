...
@Configuration
@EnableJpaRepositories(basePackages = {"com.sample.db.postgres.jsonb.data.repository"})
@EnableTransactionManagement
public class DataConfiguration {

    private static final String[] ENTITY_PACKAGES = { "com.sample.db.postgres.jsonb.data.entity" };
    ...
    @Value("${jpa.properties.hibernate.entity_dirtiness_strategy:com.sample.db.postgres.jsonb.data.strategy.EntityDirtinessStrategy}")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        jpaProperties.put("hibernate.entity_dirtiness_strategy", dirtinessStrategy);
