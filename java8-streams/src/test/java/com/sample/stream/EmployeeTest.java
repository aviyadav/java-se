...
public class EmployeeTest {
    ...
    private static Employee[] arrayOfEmps = {
        ...
        new Employee(2, "Bill Gates", 200000.00),
        new Employee(3, "Mark Zuckerberg", 300000.00)
    };
...
//    }
    ...
    public void whenStreamMapping_thenGetMap() {
        Map<Character, List<Integer>> idGroupedByAlphabet = empList.stream()
                .collect(Collectors.groupingBy(e -> new Character(e.getName().charAt(0)), Collectors.mapping(Employee::getId, Collectors.toList())));
    ...
    public void whenStreamReducing_thenGetValue() {
        ...
        Double salIncrOverhead = empList.stream().collect(Collectors.reducing(0.0, e -> e.getSalary() * percentage / 100, (s1, s2) -> s1 + s2));
