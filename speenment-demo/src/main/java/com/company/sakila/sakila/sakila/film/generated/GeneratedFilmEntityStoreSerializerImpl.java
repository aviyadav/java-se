...
public abstract class GeneratedFilmEntityStoreSerializerImpl implements EntityStoreSerializer<Film> {
    ...
    private final static int FIELD_RENTAL_DURATION = 2;
    private final static int FIELD_FILM_ID = 4;
    private final static int FIELD_LAST_UPDATE = 8;
    private final static int FKREF_FK_FILM_LANGUAGE = 16;
    private final static int ENDPOS_ORIGINAL_LANGUAGE_ID = 24;
    private final static int ENDPOS_LENGTH = 25;
    private final static int FKREF_ENDPOS_FK_FILM_LANGUAGE_ORIGINAL = 26;
    private final static int ENDPOS_RELEASE_YEAR = 27;
    private final static int ENDPOS_TITLE = 28;
    private final static int ENDPOS_DESCRIPTION = 32;
    private final static int ENDPOS_RATING = 36;
    private final static int ENDPOS_SPECIAL_FEATURES = 40;
    private final static int ENDPOS_RENTAL_RATE = 44;
    private final static int ENDPOS_REPLACEMENT_COST = 48;
    private final static int VARSIZE_BEGINS = 52;
