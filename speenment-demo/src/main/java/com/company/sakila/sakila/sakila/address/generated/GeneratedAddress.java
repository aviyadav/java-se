...
public interface GeneratedAddress {
     ...
     */
    IntField<Address, Integer> ADDRESS_ID = DatastoreFields.createIntField(
     ...
     */
    StringField<Address, String> ADDRESS = DatastoreFields.createStringField(
        Identifier.ADDRESS,
        Address::getAddress,
        Address::setAddress,
        TypeMapper.identity(),
     ...
     */
    StringField<Address, String> ADDRESS2 = DatastoreFields.createStringField(
        Identifier.ADDRESS2,
     ...
     */
    StringField<Address, String> DISTRICT = DatastoreFields.createStringField(
        Identifier.DISTRICT,
        Address::getDistrict,
        Address::setDistrict,
        TypeMapper.identity(),
     ...
     */
    IntForeignKeyField<Address, Integer, City> CITY_ID = DatastoreFields.createIntForeignKeyField(
        Identifier.CITY_ID,
        Address::getCityId,
        Address::setCityId,
        City.CITY_ID,
     ...
     */
    StringField<Address, String> POSTAL_CODE = DatastoreFields.createStringField(
     ...
     */
    StringField<Address, String> PHONE = DatastoreFields.createStringField(
        Identifier.PHONE,
        Address::getPhone,
        Address::setPhone,
        TypeMapper.identity(),
     ...
     */
    ComparableField<Address, Timestamp, Timestamp> LAST_UPDATE = DatastoreFields.createComparableField(
